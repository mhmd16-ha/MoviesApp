...
export default function TopRated() {
    ...
    async function getTopRated() {
      ...
      let { isLoading, data } = useQuery("getTopRated", getTopRated);
...
/>
   ...
   <div className='bg-color' id='movies'>
     <div className='mx-5 pt-5'>
    <h2 className="mt-2 text-light">Top <span className='main-color'>Rated Movies</span> </h2>
